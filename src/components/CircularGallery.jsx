...
class Media {
    ...
    `,
        ...
        // Handles Vite imports or direct URLs properly
        const imageSrc =
            typeof this.image === 'string'
                ? this.image
                : this.image?.default || this.image;
...
class App {
    ...
    createMedias(items, bend = 1, textColor, borderRadius, font) {
        const defaultItems = [
            ...
            { image: Image6, text: "Greetings" },
            { image: Image2, text: "Wedding Celebration" },
            { image: Image3, text: "Party Vibes" },
            { image: Image4, text: "Baby Arrival" },
            { image: Image5, text: "Golden Anniversary" },
            { image: Image6, text: "Festival Wishes" },
        ];
